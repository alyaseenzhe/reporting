            ...
            <a class="w-full" href="{{ route('list.aging') }}">
                <div
                    ...
                    <div class="px-5 pt-5">
                        ...
                        <div class="text-3xl font-semibold text-gray-800 text-center"> فواتير حسب الإستحقاق<small style="color: red"> (جديد)</small></div></div>
                </div>
    </div>
    </a>
    @endif
...
<path style="fill:#F2BF7E;" d="M407.836,424.369H295.776v47.733c0,0,7.417,31.65,40.026,32.007s40.017-31.869,40.017-31.869
	...
	L87.766,495.902z"/>
                    ...
                    <div class="text-3xl font-semibold text-gray-800 text-center"> تعمير العملاء <small style="color: red"> (جديد)</small></div>
                </div>
            </div>
        </a>
    @endif
...
<defs id="defs2"/>
                    ...
                    <div class="text-3xl font-semibold text-gray-800 text-center">فواتير عميل</div>
                </div>
            </div>
        </a>
    @endif
        ...
        <a class="w-full" href="{{ route('list.weekly-report') }}">
            <div
                ...
                <div class="px-5 pt-5">
                    ...
                    <div class="text-3xl font-semibold text-gray-800 text-center">أداء مهندسي المبيعات</div>
                </div>
            </div>
        </a>
    @endif
...
c0,4.466-3.62,8.084-8.084,8.084h-54.331c-4.465,0-8.084-3.618-8.084-8.084C300.194,434.776,303.813,431.158,308.278,431.158z"/>
                    ...
                    <div class="text-3xl font-semibold text-gray-800 text-center">تقرير نمو الموظفين</div>
                </div>
            </div>
        </a>
    @endif
