        ...
        <div class="flex flex-col sm:flex-row gap-4 w-full">
            <div class="w-full">
                ...
                <div class="flex flex-row">
                    ...
                    <div class="flex items-center mb-4 w-full">
                        <input name="report_type" wire:model="report_type" type="checkbox" value="item-sales-by-branch" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label class="mr-2 text-sm font-medium text-gray-900 dark:text-gray-300">ترتيب الفروع بكميات الأصناف</label>
                    </div>
                    <div class="flex items-center mb-4 w-full">
                        <input name="report_type" wire:model="report_type" type="checkbox" value="list-items" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label class="mr-2 text-sm font-medium text-gray-900 dark:text-gray-300">قائمة الأصناف</label>
                    </div>
                </div>
                <div class="flex flex-row">

                    <div class="flex items-center mb-4 w-full">
                        <input name="report_type" wire:model="report_type" type="checkbox" value="branch-crop-composition-collections" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label class="mr-2 text-sm font-medium text-gray-900 dark:text-gray-300">التركيب المحصولي</label>
                    </div>
                    <div class="flex items-center mb-4 w-full">
                        <input name="report_type" wire:model="report_type" type="checkbox" value="branch-crop-composition-collections-report" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label class="mr-2 text-sm font-medium text-gray-900 dark:text-gray-300">تقرير التركيب المحصولي</label>
                    </div>
                </div>
                <div class="flex flex-row">

                    <div class="flex items-center mb-4 w-full">
                        <input name="report_type" wire:model="report_type" type="checkbox" value="stock-coverage" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label class="mr-2 text-sm font-medium text-gray-900 dark:text-gray-300">تقرير كفاية المخزون</label>
                    </div>
                </div>
