            ...
            @foreach($sap_results2 as $result2)
                @if(\Illuminate\Support\Facades\Auth::user()->role == 'a' || \Illuminate\Support\Facades\Auth::user()->user_group->read_type == '0')
                    <tr>
                        <td class="border p-2 whitespace-nowrap">
                            <div>
                                <div class="text-center text-gray-800 text-sm">{{$result2 ? $result2['OldCode'] : ""}}</div>
                            </div>
                        </td>
                        <td class="border p-2 whitespace-nowrap">
                            <div>
...
{{--                                                                {{$result2 ? $result2->role : ""}}--}}
                                    ...
                                    @if($emp_position[$result2['OldCode']] == "area_manager")
                                        <span>مدير منطقة</span>
                                    @elseif($emp_position[$result2['OldCode']] == "store_manager")
                                        <span>مدير معرض</span>
                                    @elseif($emp_position[$result2['OldCode']] == "sales_manager")
                                        <span>مدير مبيعات</span>
                                    @elseif($emp_position[$result2['OldCode']] == "mat_dev_manager1")
                                        <span>تطوير مواد 1</span>
                                    @elseif($emp_position[$result2['OldCode']] == "mat_dev_manager2")
                        ...
                        <td class="border p-2 whitespace-nowrap">
                            <div>
                                <div class="text-center text-gray-800 text-sm">
                                    @if($tot >= 0 && $tot <= 120000)
                                        30
                                        <?php $commission_percentage[$emp_position[$result2['OldCode']]] = 30; ?>
                                    @elseif($tot > 120000 && $tot <= 240000)
                                        60
                                        @php $percent = 60; @endphp
                                        <?php $commission_percentage[$emp_position[$result2['OldCode']]] = 60; ?>
                                    @elseif($tot > 240000 && $tot < 400000)
                                        80
                                        @php $percent = 80; @endphp
                                        <?php $commission_percentage[$emp_position[$result2['OldCode']]] = 80; ?>
                                    @elseif($tot >= 400000)
                                        100
                                        @php $percent = 100; @endphp
                                        <?php $commission_percentage[$emp_position[$result2['OldCode']]] = 100; ?>
                                    @endif
                                </div>
                            </div>
                        </td>
...
{{--                            outstanding الآجل--}}
                            <div>
                                <div class="text-center text-gray-800 text-sm">{{$result2 ? number_format(floatval($slp_aging[$result2['SlpCode']]['balance'])) : ""}}</div>
                            </div>
                        </td>
                        <td class="border p-2 whitespace-nowrap">
                            <div>
                                <div class="text-center text-gray-800 text-sm">{{ $slp_aging[$result2['SlpCode']]['balance due'] &&  $slp_aging[$result2['SlpCode']]['balance']  && floatval(number_format($slp_aging[$result2['SlpCode']]['balance'])) != 0? number_format(floatval($slp_aging[$result2['SlpCode']]['balance due'])) . " (%".number_format(floatval($slp_aging[$result2['SlpCode']]['balance due'])/floatval($slp_aging[$result2['SlpCode']]['balance'])*100).")" : 0}}</div>
                            </div>
                        </td>
                        <td class="border p-2 whitespace-nowrap">
                            <div>
                                <div class="text-center text-gray-800 text-sm">{{$result2 ?  ($slp_aging[$result2['SlpCode']]['balance due'] &&  $slp_aging[$result2['SlpCode']]['balance']  && floatval(number_format($slp_aging[$result2['SlpCode']]['balance'])) != 0? \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->format('Y-m-d')." (". \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) ." يوم)" : "-") : ""}}</div>
                            </div>
                        </td>
                        <td class="border p-2 whitespace-nowrap">
                            <div>
                                @if(floatval(number_format($slp_aging[$result2['SlpCode']]['balance'])) == 0)
                                    @if( \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                    ...
                                    @endif
                                @else
                                    @if(number_format(floatval($slp_aging[$result2['SlpCode']]['balance due'])/floatval($slp_aging[$result2['SlpCode']]['balance'])*100) <= 20 && \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                        <span style="font-weight: bold; color: green">نعم</span>
                                            <?php $pay = true; ?>
                                    @else
                                        <span style="font-weight: bold; color: red">لا</span>
...
{{--                                                             (($result2['days'] <= 240 && ((!is_null(number_format(floatval($result2['postponed_partial']))) && number_format(floatval($result2['postponed_partial'])) != 0 && !is_null(number_format(floatval($result2['postponed_total']))) && number_format(floatval($result2['postponed_total'])) != 0))? (number_format(floatval($result2['postponed_partial']))/number_format(floatval($result2['postponed_total']))) : 0 <= 20)? "نعم" : "لا" : ""}}</div>--}}
                        ...
                        <td class="border p-2 whitespace-nowrap">
                            <div>
                                ...
                                <div class="text-center text-gray-800 text-sm">
                                    @if(floatval(number_format($slp_aging[$result2['SlpCode']]['balance'])) == 0 && \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                        {{$result2 ? number_format((floatval($branch_comission)*(floatval($result2["GrossProfitLC"])/$total_grossProfit)), 2) : ""}}
                                    @elseif(number_format(floatval($slp_aging[$result2['SlpCode']]['balance due'])/floatval($slp_aging[$result2['SlpCode']]['balance'])*100) <= 20 && \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                        {{$result2 ? number_format((floatval($branch_comission)*(floatval($result2["GrossProfitLC"])/$total_grossProfit)), 2) : ""}}
                                    @else
                                        <span>0</span>
                                    @endif
                                ...
                                <div class="text-center text-gray-800 text-sm">
                                    ...
                                    @if(floatval(number_format($slp_aging[$result2['SlpCode']]['balance'])) == 0 && \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                        {{$result2 ? number_format(floatval($emp_comm)*(5/100)) : ""}}
                                            <?php $total_sales_manager += (($result2 ? floatval($emp_comm)*(5/100) : 0)*($commission_percentage[$emp_position[$result2['OldCode']]]/100)); ?>
                                    @elseif(number_format(floatval($slp_aging[$result2['SlpCode']]['balance due'])/floatval($slp_aging[$result2['SlpCode']]['balance'])*100) <= 20 && \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                        {{$result2 ? number_format(floatval($emp_comm)*(5/100)) : ""}}
                                        <?php $total_sales_manager += (($result2 ? floatval($emp_comm)*(5/100) : 0)*($commission_percentage[$emp_position[$result2['OldCode']]]/100)); ?>
                                    @else
...
{{--                                    <span style="color: green">{{ ($commission_percentage[$emp_position[$result2['OldCode']]]/100)*((floatval($position_commission[$emp_position[$result2["OldCode"]]]['area_manager']/100))*$emp_comm) }}</span>--}}
                                    @if(floatval(number_format($slp_aging[$result2['SlpCode']]['balance'])) == 0 && \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                        {{$result2 ? number_format((floatval($position_commission[$emp_position[$result2["OldCode"]]]['area_manager']/100))*$emp_comm) : ""}}
                                        <?php $total_area_manager += ($commission_percentage[$emp_position[$result2['OldCode']]]/100)*((floatval($position_commission[$emp_position[$result2["OldCode"]]]['area_manager']/100))*$emp_comm) ?>
                                    @elseif(number_format(floatval($slp_aging[$result2['SlpCode']]['balance due'])/floatval($slp_aging[$result2['SlpCode']]['balance'])*100) <= 20 && \Carbon\Carbon::parse($slp_aging[$result2['SlpCode']]['oldest_date'])->diffInDays($last_date) <= 240)
                                        {{$result2 ? number_format((floatval($position_commission[$emp_position[$result2["OldCode"]]]['area_manager']/100))*$emp_comm) : ""}}
                                            <?php $total_area_manager += ($commission_percentage[$emp_position[$result2['OldCode']]]/100)*((floatval($position_commission[$emp_position[$result2["OldCode"]]]['area_manager']/100))*$emp_comm) ?>
                                    @else
...
{{--                                        {{$result2 ? number_format(floatval($result2['calc_store_manager'])) : ""}}--}}
                                        {{$result2 ? number_format((floatval($position_commission[$emp_position[$result2["OldCode"]]]['store_manager']/100))*$emp_comm) : ""}}
                                            ...
                                            <?php $total_store_manager += ($commission_percentage[$emp_position[$result2['OldCode']]]/100)*((floatval($position_commission[$emp_position[$result2["OldCode"]]]['store_manager']/100))*$emp_comm) ?>
...
{{--                                        {{$result2 ? number_format(floatval($result2['calc_mat_dev1'])) : ""}}--}}
                                        {{$result2 ? number_format((floatval($position_commission[$emp_position[$result2["OldCode"]]]['mat_dev_manager1']/100))*$emp_comm) : ""}}
                                            ...
                                            <?php $total_mat_dev1 += ($commission_percentage[$emp_position[$result2['OldCode']]]/100)*((floatval($position_commission[$emp_position[$result2["OldCode"]]]['mat_dev_manager1']/100))*$emp_comm) ?>
...
{{--                                            {{$result2 ? number_format(floatval($result2['calc_mat_dev2'])) : ""}}--}}
                                            {{$result2 ? number_format((floatval($position_commission[$emp_position[$result2["OldCode"]]]['mat_dev_manager2']/100))*$emp_comm) : ""}}
                                                ...
                                                <?php $total_mat_dev2 += ($commission_percentage[$emp_position[$result2['OldCode']]]/100)*((floatval($position_commission[$emp_position[$result2["OldCode"]]]['mat_dev_manager2']/100))*$emp_comm) ?>
...
{{--                                            {{$result2 ? number_format(floatval($result2['calc_mat_dev2'])) : ""}}--}}
                        ...
                        <?php $employee_postponed_due_percentage =  floatval($slp_aging[$result2['SlpCode']]['balance']) == 0? 0 : (floatval($slp_aging[$result2['SlpCode']]['balance due'])/floatval($slp_aging[$result2['SlpCode']]['balance'])*100) ?>
                        ...
                        <?php $calc_sales_manager += ($result2 && $pay? ((floatval($position_commission[$emp_position[$result2["OldCode"]]]['sales_manager']/100))*$emp_comm) : 0) ?>
                        <?php $calc_area_manager += ($result2 && $pay? ((floatval($position_commission[$emp_position[$result2["OldCode"]]]['area_manager']/100))*$emp_comm) : 0) ?>
                        <?php $calc_store_manager += ($result2 && $pay? ((floatval($position_commission[$emp_position[$result2["OldCode"]]]['store_manager']/100))*$emp_comm) : 0) ?>
                        <?php $calc_mat_dev1 += ($result2 && $pay? ((floatval($position_commission[$emp_position[$result2["OldCode"]]]['mat_dev_manager1']/100))*$emp_comm) : 0) ?>
                        <?php $calc_mat_dev2 += ($result2 && $pay? ((floatval($position_commission[$emp_position[$result2["OldCode"]]]['mat_dev_manager2']/100))*$emp_comm) : 0) ?>
