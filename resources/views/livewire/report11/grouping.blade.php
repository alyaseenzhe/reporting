        ...
        @if($currentGroup != $record["ItemGroup"])
            ...
            @if($currentGroup !== null)
                <tr wire:key="rec-{{ now() }}" style="border-top: 2px solid black; background-color: #f1d56f; font-weight: bold">
                    ...
                    <td style="border-left: 2px solid black;" style="direction: ltr" class="border p-2 whitespace-nowrap">{{number_format($trans_subtotal)}}</td>
                    <td style="border-left: 2px solid black;" style="direction: ltr" class="border p-2 whitespace-nowrap">{{number_format($quantity_subtotal)}}</td>
