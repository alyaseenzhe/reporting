                        ...
                        @if(\Illuminate\Support\Facades\Auth::user()->role == 'a' || \Illuminate\Support\Facades\Auth::user()->user_group->read_type == '0')
                            @if(strlen($record['customer_code'] ) == 7 || strlen($record['customer_code'] ) == 9)
                                <tr>
                                    ...
                                    <td class="border p-2 whitespace-nowrap">
                                        {{number_format($record['bathoor'], 2)}}
                                    </td>
                                    <td class="border p-2 whitespace-nowrap">
                                        {{number_format($record['mobedat'], 2)}}
                                    </td>
                                    <td class="border p-2 whitespace-nowrap">
                                        {{number_format($record['asmedah'], 2)}}
                                    </td>
                                    <td style="border-left: 2px solid black;" class="border p-2 whitespace-nowrap">
                                        {{number_format($record['other'], 2)}}
                                    </td>
                                    <td class="border p-2 whitespace-nowrap">
                                        {{number_format($record['speciality1'], 2)}}
                                    </td>
                                    <td class="border p-2 whitespace-nowrap">
                                        {{number_format($record['speciality2'], 2)}}
                                    </td>
                                    <td class="border p-2 whitespace-nowrap">
                                        {{number_format($record['speciality0'], 2)}}
                                    </td>
                                </tr>
                            @endif
...
@section('scripts')
    ...
    <script>
        Livewire.on('show-container', () => {
            ...
            console.log(@this.branch_postponed_due_amount_grand_total);
                    ...
                    rowGroup: {
                        ...
                        endRender: function (rows, group) {
                            ...
                            return $('<tr style="background-color: #f2f0f0; font-weight: bold; color: #233881;" />')
                                ...
                                .append('<td style="border: 1px solid;" >' + bathoorAmount.toLocaleString("en-US") + '</td>')
                                .append('<td style="border: 1px solid;" >' + mobedatAmount.toLocaleString("en-US") + '</td>')
                                .append('<td style="border: 1px solid;" >' + asmedahAmount.toLocaleString("en-US") + '</td>')
                                .append('<td style="border: 1px solid;" >' + otherAmount.toLocaleString("en-US") + '</td>')
                                .append('<td style="border: 1px solid;" >' + sp1Amount.toLocaleString("en-US") + '</td>')
                                .append('<td style="border: 1px solid;" >' + sp2Amount.toLocaleString("en-US") + '</td>')
                                .append('<td style="border: 1px solid;" >' + sp0Amount.toLocaleString("en-US") + '</td>');
                        },
                        dataSrc: [2, 3]
                    }
                    //         rowGroup: {
