        ...
        @if(count($aging_records) > 0)
            ...
            <table id="voucherTable" class="table-auto w-full border text-center">
                ...
                <tr>
                    ...
                    <th class="border p-2">
                        <div class="text-center text-sm">ايام الاستحقاق</div>
                    </th>
                </tr>
                </thead>
                    ...
                    @if($record["Business Partner Code"] != $customer_id)
                        ...
                        <tr style="background-color: #f2f0f0; font-weight: bold; color: #233881; border: dotted 2px;">
                            ...
                            <td style="border: 1px dotted;" colspan="2">
                                ...
                                <span style="@if($customer_total_120 > 0) color:red; @else color:green @endif">@if($customer_total > 0) ({{number_format((floatval($customer_total_120)/floatval($customer_total))*100, 2)}}%) @else  [0%]  @endif</span>
                            </td>
