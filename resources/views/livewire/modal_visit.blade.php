                ...
                <div class="border rounded-xl shadow p-4">
                    <h2 class="text-sm font-semibold cursor-pointer collapse-toggle">
                        <div class="flex items-center gap-2">
                            <!-- Arrow Icon -->
                            <svg class="w-4 h-4 text-gray-600 transition-transform transform collapse-arrow {{ $record->status == 5 && $isReviewWritten ? 'rotate-180' : '' }}"
...
//                                        $allReviewsDone = $this->reviews_done();
                    ...
                    @if($isReviewWritten  )
                        ...
                        <div class="collapse-content mt-9 text-gray-600 {{ $record->status == 5 && $isReviewWritten ? '' : 'hidden' }}">
            ...
            @foreach($record->emps_recipients as $rec_record)
                ...
                <div class="border rounded-xl shadow p-4">
                    ...
                    @if($isReviewWritten)
                        ...
                        {{--                            @dd($rec_record)--}}
                        {{--                            @if($isrRecipientReview)--}}
                        <div class="collapse-content mt-9 text-gray-600 {{ $record->status == 5 ? '' : 'hidden' }}">
