...
order by EmpCode, VoucherDate asc) as oldest_voucher /* end of oldest_voucher tbl*/ from /* start of tb1*/ (SELECT Employeecode, EmployeeName, branchname, tbl_left_emp_commission.area, area_commission, area_profit, employee_profit, percentage_area_employee, tbl_left_emp_commission.employee_commission, role, sales_manager, area_manager, store_manager, mat_dev_manager1, mat_dev_manager2, (tbl_left_emp_commission.employee_commission*(tbl_employees_position.sales_manager/100)) as calc_sales_manager, (tbl_left_emp_commission.employee_commission*(tbl_employees_position.area_manager/100)) as calc_area_manager, (tbl_left_emp_commission.employee_commission*(tbl_employees_position.store_manager/100)) as calc_store_manager, (tbl_left_emp_commission.employee_commission*(tbl_employees_position.mat_dev_manager1/100)) as calc_mat_dev1, (tbl_left_emp_commission.employee_commission*(tbl_employees_position.mat_dev_manager2/100)) as calc_mat_dev2 FROM (select Employeecode, EmployeeName, branchname, area, area_commission, area_profit, employee_profit, ((employee_profit/area_profit)*100) as percentage_area_employee, ((((employee_profit/area_profit)*100)*area_commission)/100) as employee_commission from (SELECT * FROM (SELECT tbl_employee_profit.Employeecode, tbl_employee_profit.EmployeeName, tbl_employee_profit.branchname, tbl_employee_profit.area, SUM(tbl_employee_profit.profit_sp0+tbl_employee_profit.profit_sp1+tbl_employee_profit.profit_sp2) AS employee_profit FROM (select Employeecode,Employeename,branchName, area, SPL0, sum(Spl0Value - Spl0cost) as profit_sp0, SPL1, sum(Spl1Value - Spl1cost) as profit_sp1, SPL2, sum(Spl2Value - Spl2cost) as profit_sp2
from (
